...
ALLOWED_HOSTS += ["api.alijonov.com", "localhost", "127.0.0.1", "146.190.84.109", "localhost:3000"]
...
# STATIC
# ------------------------
STATICFILES_STORAGE = "uzum.utils.storages.StaticRootS3Boto3Storage"
COLLECTFAST_STRATEGY = "collectfast.strategies.boto3.Boto3Strategy"
STATIC_URL = f"https://{aws_s3_domain}/static/"
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "uzum.utils.storages.MediaRootS3Boto3Storage"
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="uzum <noreply@shortintroduce.com>",
)
