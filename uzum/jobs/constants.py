# export const MAX_OFFSET = 9952;
# export const PAGE_SIZE = 100;
# export const MAX_PAGE_SIZE = 100;
# export const PRODUCTIDS_CONCURRENT_REQUESTS = 10;
# export const PRODUCT_CONCURRENT_REQUESTS = 100;
# export const PRODUCT_REVIEWS_SIZE = 500;
# export const PRODUCTS_BUFFER_SIZE = 10000;
# export const PRODUCTS_REQUEST_BREAK_INDEX = 10000;
...
PRODUCT_CONCURRENT_REQUESTS_LIMIT = 60  # number of concurrent requests for fetching product details
