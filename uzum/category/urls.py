...
urlpatterns = [
    ...
    path("segmentation/monthly/", views.AllCategoriesMonthlySegmentation.as_view(), name="segmentation"),
    path("segmentation/weekly/", views.AllCategoriesWeeklySegmentation.as_view(), name="segmentation"),
    path("toexcel/", views.CategoriesToExcelView.as_view(), name="segmentation"),
    path(
