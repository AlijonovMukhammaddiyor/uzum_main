...
from uzum.payment.utils import make_aware_datetime as mad
...
class GetStatement:
    ...
    def __call__(self, params: dict):
        ...
        start_date, end_date = mad(int(clean_data.get("start_date")), int(clean_data.get("end_date")))

        try:
            transactions = MerchatTransactionsModel.objects.filter(
